...
const ManufacturerInfo = ({ productData }) => {
  const fromManufacturer = productData?.from_manufacturer || "";

  return (
    <div className="manufacturer">
      <h3>From the manufacturer</h3>

      {/* Only render if from_manufacturer has content */}
      {fromManufacturer ? (
        <div
          className="manufacturer-content"
          dangerouslySetInnerHTML={{ __html: fromManufacturer }}
        />
      ) : (
