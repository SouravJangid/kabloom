...
//     const children = Array.isArray(_get(productDetailsData, 'child', []))
//         ? _get(productDetailsData, 'child', [])
//         : [];
...
//         genericGetData({
//             dispatch,
//             url: `/connect/index/product?prodid=37505&store_id=1&loc_id=${loc_id}&dineinTime=${dineinTime}&zipCode=${zipcode}&courier_type=${couriertype}`,
//             constants: {
...
//         fetch(`${APPLICATION_BFF_URL}/connect/index/product?prodid=37505&store_id=1&loc_id=${loc_id}&dineinTime=${dineinTime}&zipCode=${zip}&courier_type=${couriertype}`)
//             .then(r => r.json())
//             .then(data => {
...
//                     <Col className='pdp-image-galary'>
//                         <div className="proName top">
//                             {_get(productDetailsData, 'name', 'Loading...')}
//                         </div>
...
//                                         <h4>Color <span className="selected">{_get(selectedChild, 'color_theme', '')}</span></h4>
...
//                                     <div className="option-section">
//                                         <h4>
//                                             Styles <span className="selected">{_get(selectedChild, 'style', '—')}</span>
//                                         </h4>
//                                         {(() => {
...
//                                                             <h3><b>{_get(selectedChild, "style", "_")}</b></h3>
//                                                             <span>1 option from</span>
//                                                             <span className="price">₹{_get(selectedChild, "price", "—")}</span>
//                                                         </div>
//                                                     </div>
//                                                 </div>
//                                             );
...
//                                                         <p className="delivery-type">{option.Type || "N/A"}</p>
...
//                             <div className="product-description">{_get(selectedChild, 'short_description', 'N/A')}</div>
//                             <hr />
//                         </div>
//                     </Col>

//                     <Col className="pdp-buy">
...
//                                 />
//                             </div>
//                             <div className="stock-status">{_get(selectedChild, 'stock_availability', 'N/A')}</div>
//                             {!zipVerified && (
...
//                 <p>{_get(selectedChild, "description", 'N/A')}</p>
//             </div>
//             <hr />
//             <ProductCard />
//             <hr />
